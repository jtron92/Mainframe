...
The include statement can hold dd statements so you dont have to code it from scratch , you can just refer back to it but 
if its in a private libray you gotta add the location of that 

remember also the JCLLIB ORDER comes first before the step

Below is the member  TRAIN2    location is Z38515.ALPHA
